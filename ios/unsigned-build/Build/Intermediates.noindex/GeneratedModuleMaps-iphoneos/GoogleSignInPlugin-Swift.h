...
#ifndef GOOGLESIGNINPLUGIN_SWIFT_H
#define GOOGLESIGNINPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GoogleSignInPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class SignInResult;
SWIFT_CLASS("_TtC18GoogleSignInPlugin16GoogleSignInImpl")
@interface GoogleSignInImpl : NSObject
- (void)initialize:(InitializeOptions * _Nonnull)options completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)signInCompletion:(void (^ _Nonnull)(SignInResult * _Nullable, NSError * _Nullable))completion;
- (void)signOutWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
SWIFT_CLASS("_TtC18GoogleSignInPlugin17InitializeOptions")
@interface InitializeOptions : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_PROTOCOL("_TtP18GoogleSignInPlugin6Result_")
@protocol Result
- (id _Nonnull)toJSObject SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC18GoogleSignInPlugin12SignInResult")
@interface SignInResult : NSObject <Result>
- (id _Nonnull)toJSObject SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
